...
# Introduction
Movies have long been a major part of entertainment throughout the world, shaping trends and influencing audiences, with their financial success often reflecting their cultural impact. We'll explore the top 1,000 highest-grossing Hollywood movies as of January 2020, sourced from IMDB and Rotten Tomatoes. Focusing on distributors with at least 90 movies in this list, we'll examine their box office performance and analyze Disney's dominance compared to other studios. We'll also explore key factors such as runtime, movie rating, and worldwide box office sales to gain deeper insights into the success of these films.
...
Next, we'll look at the average world sales by distributor to see which studios tend to generate the highest box office revenue per movie. Again, Disney is leading in this metric as well with an average of around $500 million in box office sales per movie.
...
We can also break down box office performance by runtime, offering insights into the types of movies studios release and their financial success. By examining the differences in revenue across various runtime groups, we can investigate whether there is a correlation between movie length and box office success.
